...
class InventoryMetaView(APIView):
    ...
    def get(self, request):
        return Response({
            ...
            'units': [
                {'id': 1, 'value': 'piece',  'label': 'Piece'},
                {'id': 2, 'value': 'bottle', 'label': 'Bottle'},
                {'id': 3, 'value': 'box',    'label': 'Box'},
                {'id': 4, 'value': 'ml',     'label': 'ml'},
                {'id': 5, 'value': 'g',      'label': 'g'},
                {'id': 6, 'value': 'pair',   'label': 'Pair'},
                {'id': 7, 'value': 'set',    'label': 'Set'},
                {'id': 8, 'value': 'roll',   'label': 'Roll'},
            ],
            'movement_types': [
